...
The app remains local-first: existing projects and package imports (legacy v1/v2 and project v3) still use the browser's IndexedDB. The new D1/R2 API does **not** upload or synchronize them yet. Keep exporting ZIP backups.
